...
const Testimonials = () => {
  ...
  return (
    <section className="testimonials-one section- py-2" id="testimonial">
      <div
        className="testimonials-one__bg"
        style={{
          backgroundImage:
      ...
      <div className="testimonials-one__inner">
        ...
        >
          {testimonials.map((item, index) => (
            <SwiperSlide key={index}>
              <div className="testimonials-one__item">
                <div className="testimonials-card testimonials-card--one borderrr">
                  <p className="testimonials-card__text">
                    "{item.text}"
                  </p>

                  <div
                    className="testimonials-card__ontent "
                    style={{
                      display: "flx",
                  ...
                  >
                    ...
                    >
                      ...
                      <div
                        className="testimonials-card__uthor"
